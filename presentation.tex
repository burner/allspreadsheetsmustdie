...
\begin{document}
	...
	\begin{frame}[fragile]{A random list of languages we love to hate}
		\begin{tikzpicture}[remember picture,overlay]
		    ...
		    %\node[xshift=75mm,yshift=-38mm,rotate=-15,anchor=north west] 
			%	at (current page.north west){};
		    %\node[xshift=15mm,yshift=-28mm,rotate=15,anchor=north west] 
			%	at (current page.north west){\includegraphics[width=30mm]{rustlogo.png}};
		    %\node[xshift=15mm,yshift=-48mm,rotate=15,anchor=north west] 
			%	at (current page.north west){\includegraphics[width=30mm]{golang.png}};
		\end{tikzpicture}
	\end{frame}
...
\end{lstlisting}
	...
	\begin{frame}{GraphQLD}
		...
		\begin{itemize}
			...
			\item $\approx 9000$ are generated by darser
			\item ready for use
		\end{itemize}	
	\end{frame}
